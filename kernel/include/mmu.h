...
#define MAIR_EL1_VALUE		    (MT_DEVICE_nGnRnE_FLAGS << (8 * MT_DEVICE_nGnRnE)) | (MT_NORMAL_NC_FLAGS << (8 * MT_NORMAL_NC))
...
#define TCR_EL1_VALUE		(TCR_T0SZ | TCR_T1SZ | TCR_TG0_4K | TCR_TG1_4K)
